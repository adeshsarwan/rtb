...
public class Probe {
	...
	public static final StringBuilder BID_CREAT_IS_AUDIO = new StringBuilder("Creative is audio, request is not\n");
	...
	public static final StringBuilder AUDIO_STARTDELAY = new StringBuilder("Audio startdelay is too short\n");
	public static final StringBuilder AUDIO_TOO_SHORT = new StringBuilder("Audio Creative min duration not long enough\n");
	public static final StringBuilder AUDIO_TOO_LONG = new StringBuilder("Audio Creative max duration too short\n");
	public static final StringBuilder AUDIO_PROTOCOL = new StringBuilder("Audio Creative protocols don't match\n");
	public static final StringBuilder AUDIO_MIME = new StringBuilder("Audio Creative mime type mismatch");
